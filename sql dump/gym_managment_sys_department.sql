...
CREATE TABLE `department` (
  ...
  `dept_branch` int(11) NOT NULL,
  `dept_head` int(11) DEFAULT NULL,
  PRIMARY KEY (`dept_name`,`dept_branch`),
  KEY `depfk_idx` (`dept_branch`),
  KEY `depfk2_idx` (`dept_head`),
  CONSTRAINT `depfk1` FOREIGN KEY (`dept_branch`) REFERENCES `branch` (`bid`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `depfk2` FOREIGN KEY (`dept_head`) REFERENCES `employee` (`eid`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2022-09-19  4:37:55
