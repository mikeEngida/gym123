...
CREATE TABLE `client_programme` (
  ...
  PRIMARY KEY (`cid`,`pid`),
  KEY `fk2_idx` (`pid`),
  CONSTRAINT `fk1` FOREIGN KEY (`cid`) REFERENCES `client` (`cid`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk2` FOREIGN KEY (`pid`) REFERENCES `programme` (`pid`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `client_programme` VALUES (1,1),(7,1);
...
-- Dump completed on 2022-09-19  4:37:54
